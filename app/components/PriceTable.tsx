      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            ...
            <span className="text-[#ff0066]">料金プラン</span>
          </h2>
            ...
            <button
              ...
              className={`px-8 py-3 rounded-full font-semibold transition-all duration-300 ${
                activeTab === 'individual'
                  ? 'bg-gradient-to-r from-[#ff0066] to-[#ff3399] text-black shadow-lg shadow-[#ff0066]/30'
          ...
          <div className="flex justify-center mb-8 px-4">
            <button
              ...
              className={`relative px-8 py-5 rounded-2xl font-semibold transition-all duration-300 border-2 max-w-2xl w-full shadow-lg transform hover:scale-[1.02] ${
                is100Plus
                  ? 'bg-gradient-to-br from-[#ff0066]/30 to-[#ff0066]/10 border-[#ff0066] shadow-[#ff0066]/20'
                  : 'bg-white/5 backdrop-blur-sm border-white/20 hover:border-[#ff0066]/50 hover:bg-white/10 shadow-black/20'
              }`}
            >
              <div className="flex items-start gap-4">
                ...
                <div className="text-left flex-1">
                  <p className={`text-lg font-bold mb-1 ${is100Plus ? 'text-[#ff0066]' : 'text-white'}`}>
                    100回線以上（継続）専用プラン
                  </p>
                  <p className={`text-sm leading-relaxed ${is100Plus ? 'text-[#ff0066]/90' : 'text-white/60'}`}>
              ...
              {/* Hover indicator */}
              {!is100Plus && (
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#ff0066]/0 via-[#ff0066]/5 to-[#ff0066]/0 opacity-0 hover:opacity-100 transition-opacity pointer-events-none"></div>
              )}
            </button>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {currentPlans.map((plan, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6 hover:border-[#ff0066]/50 hover:shadow-xl hover:shadow-[#ff0066]/10 transition-all duration-300 transform hover:scale-105"
            >
              <div className="text-center">
                ...
                {is100Plus ? (
                  <div className="mb-2">
                    ...
                    <div className="text-sm text-[#ff3399] font-semibold mb-1">
                      {index === 0 ? '-50円' : '-100円'}
                    </div>
                    <div className="text-4xl font-bold">
                      <span className="text-[#ff0066]">{plan.price}</span>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            <div>
              <h4 className="text-[#ff0066] font-semibold mb-2">追加データ</h4>
            ...
            <div>
              <h4 className="text-[#ff0066] font-semibold mb-2">通話料</h4>
              <ul className="text-white/70 space-y-1">
            ...
            <div>
              <h4 className="text-[#ff0066] font-semibold mb-2">定額通話オプション</h4>
              <ul className="text-white/70 space-y-1">
            ...
            <div>
              <h4 className="text-[#ff0066] font-semibold mb-2">初回3ヶ月パック</h4>
              <ul className="text-white/70 space-y-1">
